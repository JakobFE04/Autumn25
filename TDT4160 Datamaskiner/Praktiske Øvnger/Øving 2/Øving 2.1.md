# Denne filen inneholder skjelettet til Oppgave 1 på Praktisk Øving 2 i TDT4160
...
# Forlater sum_array-funksjonen her

# Liste = a0

# len(liste) = a1

add t0, x0, x0 # temp tom teller for loop

add t1, x0, x0 # temp for summe liste

add t2, x0, x0 # temp for hoppe opp i liste

loop:

beq t0, a1, done # sjekk om har gått igjennom alle verdiene

lw t1, t2(a0) # Legger til verdien fra listen

add a7, a7, t1

addi t2, t2, 4 # Hopper til neste verdi i listen

addi t0, t0, 1 # tell opp for hver loop sekvens
...
add a0, t1, x0 # Legger summen av listen i a0
