...
network_data = pd.read_csv("~/Documents/Autumn25/TTT4265 ESDA 2/Designnotat/Designnotat VII/Kode/D7-take1.csv")
...
ax1.vlines(1191.281331626197,-16,0,colors='green',linestyles='dashed',label="Knekkfrekvens [-3 dB]")
ax1.vlines(1580.104305242817,-16,0,colors='blue',linestyles='dashed',label="Dempet frekvens [-10 dB]")
ax1.vlines(1275,-16,-3,colors='red',label="Akseptgrenser")
ax1.vlines(1700,-10,0,colors='red')
ax1.hlines(-3,930,1275,colors='red')
ax1.hlines(-10,1700,1800,colors='red')
ax1.fill_betweenx([-16, -3], 930, 1275, color='red', alpha=0.1)
ax1.fill_betweenx([-10, 0], 1700, 1800, color='red', alpha=0.1)
# ax1.set_xscale('log')
