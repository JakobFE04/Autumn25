...
network_data = pd.read_csv("~/Documents/Autumn25/TTT4265 ESDA 2/Designnotat/Designnotat VIII/Data/Network -30 dB 800-7kHz filter.csv")

# Frequency (Hz)  Channel 1 Magnitude (dB)  Channel 2 Magnitude (dB)  Channel 2 Phase (deg)
scope_data = pd.read_csv("Scope n=1 Filter og støy copy.csv")

# Frequency (Hz)  Trace 2 (dBV)  Phase (deg)  Trace 3 (dBV)  Phase (deg).1  Trace 4 (dBV)  Phase (deg).2
spectrum_data = pd.read_csv("Spectrum n=1 Filter SAMPLE.csv")

spectrum_data_2 = pd.read_csv("Spectrum n=1 Filter EXP AVG.csv")
...
ax1.vlines(2280,-30,0,colors='green',linestyles='dashed',label="2.28 kHZ")
...
ax1.hlines(-3,2187.2,2393.6,colors='red',linestyles='dashed',label="Båndbredde 206 Hz")
...
# ax4.set_xscale('log')
ax4.vlines(2280,-60,-40,colors='green',linestyles='dashed',label="2280 Hz")
